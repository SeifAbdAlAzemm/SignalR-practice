using MyRepository = SereneSignalR.Administration.Repositories.UserPermissionRepository;
using MyRow = SereneSignalR.Administration.UserPermissionRow;

namespace SereneSignalR.Administration.Endpoints;
